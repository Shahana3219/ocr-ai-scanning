<?php
// File: application/models/Equipment_timesheet_model.php
defined('BASEPATH') OR exit('No direct script access allowed');

class ocr_model extends CI_Model {
    
    // private $table = 'tbl_equipment_timesheets';
    // private $details_table = 'tbl_equipment_timesheet_details';
    // private $equipments_table = 'tbl_equipments';
	// private $equipment_types_table = 'tbl_equipment_types';
    // private $sec_table = 'tbl_profile';
    // private $project_table = 'tbl_project';
    // Invoice OCR tables
    private $tbl_docs  = 'invoice_documents';
    private $tbl_pages = 'invoice_document_pages';
    private $tbl_inv   = 'invoices';
